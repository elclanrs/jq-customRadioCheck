 ...
 * Author: Cedric Ruiz
 * License: MIT
 */(function(){$.fn.customRadioCheck=function(){return this.each(function(){var e=$(this),t=$("<span/>");t.addClass("custom-"+(e.is(":checkbox")?"check":"radio")),e.is(":checked")&&t.addClass("checked"),t.insertAfter(e),e.parent("label").addClass("custom-label").attr("onclick",""),e.css({position:"absolute",left:"-9999px"}),e.on({change:function(){var e=$(this);e.is(":radio")&&e.parent().siblings("label").find(".custom-radio").removeClass("checked"),t.toggleClass("checked",$(this).is(":checked"))},focus:function(){t.addClass("focus")},blur:function(){t.removeClass("focus")},click:function(){$(this).trigger("focus")}})})}})();